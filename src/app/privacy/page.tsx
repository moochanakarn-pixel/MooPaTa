    ...
    <main className="mx-auto max-w-2xl px-6 py-16 text-neutral-300">
      ...
      <div className="space-y-6 text-sm leading-relaxed">
        <section>
          ...
          <p>เมื่อสมัครใช้งาน MooPaTa เราจะเก็บข้อมูลต่อไปนี้:</p>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-neutral-400">
            <li>
              ชื่อและรูปโปรไฟล์ — จากบัญชี Google ของคุณ (ถ้าเข้าสู่ระบบด้วย Google) หรือที่คุณตั้งเองในหน้าตั้งค่า
            </li>
            <li>อีเมล/รหัสผ่านที่คุณตั้งไว้ (รหัสผ่านเข้ารหัสแบบ hash ไม่เก็บเป็นข้อความธรรมดา)</li>
            <li>
              ข้อมูล activity ที่คุณบันทึกเอง เช่น ระยะทาง เวลา อัตราการเต้นหัวใจ ท่าออกกำลังกาย
              รวมถึงข้อมูลอาหาร น้ำ น้ำหนัก และอาหารเสริมที่คุณบันทึก
            </li>
            <li>
              Access token / refresh token ของผู้ให้บริการ OAuth ที่คุณเชื่อมต่อ (เข้ารหัสด้วย AES-256-GCM ก่อนเก็บ ไม่เก็บเป็นข้อความธรรมดา)
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-400">
            ...
            นอกเหนือจากการเรียก API ของผู้ให้บริการ OAuth ที่คุณเลือกเชื่อมต่อเอง (Google) ซึ่งจำเป็นต่อการเข้าสู่ระบบ
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-neutral-400">
            ข้อมูลถูกเก็บในฐานข้อมูลของผู้ดูแลระบบแอพนี้จนกว่าคุณจะลบบัญชี Token/รหัสผ่านทุกตัวเข้ารหัสไว้ที่ฐานข้อมูล
        ...
        <section>
          ...
          <p className="text-neutral-400">
            คุณสามารถลบบัญชีพร้อมข้อมูลทั้งหมดได้ทุกเมื่อจากหน้า{" "}
