...
import { fetchStravaActivityDetail, fetchStravaActivityStreams, StravaRateLimitError } from "@/lib/providers/strava";
...
// endpoint doesn't include (splits, best efforts, device name, time-series
// streams) — on demand, only when the user actually opens this activity,
// since it costs 2 extra Strava API calls. Once cached it's never re-fetched
// (historical activities don't change).
