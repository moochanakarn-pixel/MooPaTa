  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative" style={{ width: MAIN_SIZE, height: MAIN_SIZE }}>
        <svg width={MAIN_SIZE} height={MAIN_SIZE} className="-rotate-90" viewBox={`0 0 ${MAIN_SIZE} ${MAIN_SIZE}`}>
          <circle cx={MAIN_SIZE / 2} cy={MAIN_SIZE / 2} r={MAIN_RADIUS} fill="none" stroke="#e8e0d0" strokeWidth={MAIN_STROKE} />
          {target > 0 && (
            <circle
              cx={MAIN_SIZE / 2}
              cy={MAIN_SIZE / 2}
...
function MacroRing({ page }: { page: NutrientPage }) {
  ...
  return (
    <div className="flex flex-1 flex-col items-center">
      <div className="relative" style={{ width: MACRO_SIZE, height: MACRO_SIZE }}>
        <svg width={MACRO_SIZE} height={MACRO_SIZE} className="-rotate-90" viewBox={`0 0 ${MACRO_SIZE} ${MACRO_SIZE}`}>
          <circle cx={MACRO_SIZE / 2} cy={MACRO_SIZE / 2} r={MACRO_RADIUS} fill="none" stroke="#e8e0d0" strokeWidth={MACRO_STROKE} />
          {target > 0 && (
            <circle
              cx={MACRO_SIZE / 2}
              cy={MACRO_SIZE / 2}
