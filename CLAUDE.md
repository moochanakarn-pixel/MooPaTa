...
- **การ์ดแชร์กิจกรรมเดี่ยว** (`/api/share/[id]/route.tsx`, ปุ่ม "แชร์" ที่หน้ารายละเอียดกิจกรรม เปิด
  ...
  - **หัวการ์ด = โลโก้ mascot เดี่ยว ๆ ไม่มีคำว่า "MooPaTa" แล้ว** — เดิมมีทั้งไอคอนสี่เหลี่ยม "M" +
    ...
    `Picture/mascot-1.png` 1254×1254 ให้เหลือ 256×256 ก่อน commit กันไฟล์หนักเกินจำเป็น — การ์ดโชว์แค่
    72×72) ปักมุมซ้ายบนตายตัว ไม่ขยับตาม `?pos` เพราะถือเป็นแค่ตรามุมเล็ก ๆ ไม่ใช่ "รายละเอียด" — โหลด
