...
- Activity pages: `/dashboard` (list), `/dashboard/activity/[id]` (detail), `/dashboard/log-activity`
  ...
  - **`Activity.maxSpeedMs` กรอกเองได้แล้ว ("เพซ/ความเร็วสูงสุด")** — ผู้ใช้เอาไว้เก็บสถิติเทียบกันเอง
    ...
    แรก (โชว์ "-" มาตลอดเพราะไม่มีทางกรอกค่านี้ได้) — **ไม่ได้เพิ่มการอ่านค่านี้จาก AI-import** ("นำเข้า
    จาก AI") รอบนี้ตามที่ผู้ใช้ขอแค่ให้กรอกเองได้ ไม่ได้ขอ AI-import เพิ่ม — เพิ่มทีหลังได้ถ้าต้องการ
