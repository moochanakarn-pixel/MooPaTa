...
- **การ์ดแชร์กิจกรรมเดี่ยว** (`/api/share/[id]/route.tsx`, ปุ่ม "แชร์" ที่หน้ารายละเอียดกิจกรรม เปิด
  ...
  - **`?style=list`** — เพิ่มตามคำขอผู้ใช้ (อยากแคปรายการท่าออกกำลังกายทั้งหมดออกมาเป็นรูปเดียวยาว ๆ
    แทนการ scroll แคปทีละหน้าจอ) โชว์ทุกท่า+ทุกเซ็ทเต็ม ๆ (การ์ดย่อยแยกทีละท่า, แต่ละเซ็ทเป็นแถว "เซ็ท N"
    ซ้าย + "N ครั้ง × W กก. (RPE R)" ขวา — ข้อความ `setDetail()` ใน `share-card-i18n.ts` เลียนแบบ
    inline render เดิมที่หน้ารายละเอียดกิจกรรมทุกตัวอักษร) ไม่มี hero number/กริดสถิติ/เส้นทางเลย เพราะ
